...
import org.jboss.as.naming.subsystem.NamingSubsystemXMLPersister;
import org.jboss.as.naming.subsystem.RemoteNamingResourceDefinition;
...
public class NamingExtension implements Extension {
    ...
    static final SensitiveTargetAccessConstraintDefinition IIOP_VIEW_CONSTRAINT = new SensitiveTargetAccessConstraintDefinition(
            new SensitivityClassification(SUBSYSTEM_NAME, "iiop-view", false, true, true));
    ...
    public void initialize(ExtensionContext context) {
        ...
        if (context.isRuntimeOnlyRegistrationValid()) {
            registration.registerOperationHandler(
                    NamingSubsystemRootResourceDefinition.IIOP_VIEW,
                    IIOPViewOperation.INSTANCE, false);
        }
